...
#ifndef DESTINYCORE_HOTFIXDATABASE_H
#define DESTINYCORE_HOTFIXDATABASE_H
...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_AREA_POI_STATE,
    HOTFIX_SEL_AREA_POI_STATE_LOCALE,
    ...
    HOTFIX_SEL_CHR_SHIPMENT,
    HOTFIX_SEL_CHR_SHIPMENT_CONTAINER,
    HOTFIX_SEL_CHR_SHIPMENT_CONTAINER_LOCALE,
