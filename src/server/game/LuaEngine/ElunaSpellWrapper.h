...
#ifdef ELUNA_TRINITY
    std::shared_ptr<ElunaProcInfo> m_scriptRef;
#endif
...
#ifdef ELUNA_TRINITY
    std::weak_ptr<ElunaProcInfo> GetWeakPtr() const { return m_scriptRef; }
#endif
...
#ifdef ELUNA_TRINITY
    std::shared_ptr<ElunaSpellInfo> m_scriptRef;
#endif
public:
...
#ifdef ELUNA_TRINITY
    std::weak_ptr<ElunaSpellInfo> GetWeakPtr() const { return m_scriptRef; }
#endif
};
